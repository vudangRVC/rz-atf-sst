...
extern int32_t esd_check_int(int32_t sd_port);
extern int32_t esd_set_buffer(int32_t sd_port, void *buff, uint32_t size);
extern int32_t esd_get_partition_id(int32_t sd_port, int32_t *id);
extern int32_t esd_main(void);

/* ---- Target CPU I/F ---- */
extern int32_t esddev_init(int32_t sd_port);
extern int32_t esddev_power_on(int32_t sd_port);
extern int32_t esddev_power_off(int32_t sd_port);
extern int32_t esddev_read_data (int32_t sd_port, uint8_t *buff, uint32_t reg_addr, int32_t num);
extern int32_t esddev_write_data(int32_t sd_port, uint8_t *buff, uint32_t reg_addr, int32_t num);

extern uint32_t esddev_get_clockdiv (int32_t sd_port, int32_t clock );
extern int32_t esddev_set_port(int32_t sd_port, int32_t mode);
extern int32_t esddev_int_wait(int32_t sd_port, int32_t msec);
extern int32_t esddev_init_dma(int32_t sd_port, uint32_t buffadr, int32_t regadr);
extern int32_t esddev_wait_dma_end(int32_t sd_port, int32_t cnt);
extern int32_t esddev_disable_dma(int32_t sd_port);
extern int32_t esddev_loc_cpu(int32_t sd_port);
extern int32_t esddev_unl_cpu(int32_t sd_port);
extern int32_t esddev_cd_layout(int32_t sd_port);
extern int32_t esddev_reset_dma(int32_t sd_port);
extern int32_t esddev_finalize_dma(int32_t sd_port);
extern int32_t esddev_finalize(int32_t sd_port);
extern int32_t esddev_wp_layout(int32_t sd_port);
