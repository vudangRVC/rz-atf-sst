...
{
	rzcmn_gic_data.gicd_base = bl31_board_cfg[soc_id].gicd_base;
	rzcmn_gic_data.gicr_base = bl31_board_cfg[soc_id].gicr_base;
	rzcmn_gic_data.rdistif_num = bl31_board_cfg[soc_id].platform_core_count;
