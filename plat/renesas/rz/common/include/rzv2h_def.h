...
#define RZV2H_DTB_LIMIT				UL(0x08160000)
#define RZV2H_DTB_BASE				UL(0x08130000)

#define RZV2H_MAILBOX_BASE			UL(0x08120000)  /* RZV2H_BL2_BASE + 0x1D000 (Maximum BL2 SRAM size) */
#define RZV2H_MAILBOX_SIZE			UL(0x2000)
...
#define RZV2H_PARAMS_BASE			RZV2H_BL2_LIMIT
#define RZ_SOC_BOOTINFO_BASE		RZV2H_BOOTINFO_BASE
#define BOOT_KIND_BASE				RZV2H_PARAMS_BASE

#define RZ_SOC_SYC_BASE				RZV2H_SYC_BASE

#define RZV2H_SOC_GICD_BASE			RZV2H_GICD_BASE
#define RZV2H_SOC_GICR_BASE			RZV2H_GICR_BASE
...
#define RZV2H_SYS_BASE					RZV2H_SYSC_BASE
#define RZV2H_PFC_BASE					RZV2H_GPIO_BASE
...
/* eMMC registers */
#define RZV2H_MMC0_SD_BASE				RZV2H_SD0_BASE
#define RZV2H_MMC1_SD_BASE				RZV2H_SD1_BASE
#define RZV2H_MMC2_SD_BASE				RZV2H_SD2_BASE
...
/* RZV2H CHIP ID */
#define RZV2H_CHIPID_WORD0   0x0 
#define RZV2H_CHIPID_WORD1   0x0 
#define RZV2H_CHIPID_WORD2   0x0 
#define RZV2H_CHIPID_WORD3   0x1a884a2a
