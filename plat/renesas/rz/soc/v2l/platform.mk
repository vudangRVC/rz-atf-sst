...
BL31_SOURCES			+=	plat/renesas/rz/common/rz_fconf.c		\
...
BL2_BIN_LIMIT := $(shell grep 'RZG2L_BINARY_LIMIT_SIZE' plat/renesas/rz/common/include/rz_soc_def.h | sed -E 's/.*\((0x[0-9A-Fa-f]+)\).*/\1/')
